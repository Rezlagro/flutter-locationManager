...
public class LocationManagerLocationService extends Service {
  private static final String TAG = "FlutterLocationManager";
  private static final int ONGOING_NOTIFICATION_ID = 75415;
  private static final String CHANNEL_ID = "LocationManager_channel_01";
  private final String WAKELOCK_TAG = "LocationManagerLocationService:Wakelock";
  private final String WIFILOCK_TAG = "LocationManagerLocationService:WifiLock";
  ...
  class LocalBinder extends Binder {
    private final LocationManagerLocationService locationService;

    LocalBinder(LocationManagerLocationService locationService) {
      this.locationService = locationService;
    }

    public LocationManagerLocationService getLocationService() {
