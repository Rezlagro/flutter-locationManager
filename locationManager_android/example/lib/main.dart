...
import 'package:geolocator_android/locationManager_android.dart';
...
class LocationWidget extends StatefulWidget {
  ...
  static ExamplePage createPage() {
    return ExamplePage(
        Icons.location_on, (context) => const LocationWidget());
  }
...
class _LocationWidgetState extends State<LocationWidget> {
  ...
  final LocationPlatform geolocatorAndroid = LocationPlatform.instance;
