...
import 'package:malcolmx/location_manager/locationManager.dart';

export 'package:malcolmx/locationManager_android/lib/locationManager_android.dart'
...
.instance.requestPermission();
  ...
  static Future<bool> isLocationServiceEnabled() =>
      LocationPlatform
.instance.isLocationServiceEnabled();
...
.instance.getLastKnownPosition(
  ...
  static Future<Position> konumal({
...
.instance
    ...
    try {
      LocationPermission permission = await locationManager.requestPermission();
      if (permission == LocationPermission.denied) {
        return;
      }
      Position? position = await locationManager.konumal(
...
.instance.getLocationAccuracy();
  ...
  static Stream<ServiceStatus> getServiceStatusStream() =>
      LocationPlatform
.instance.getServiceStatusStream();
  ...
  static Future<LocationAccuracyStatus> requestTemporaryFullAccuracy({
    required String purposeKey,
      ...
      LocationPlatform
.instance.requestTemporaryFullAccuracy(
  ...
  static Future<bool> openAppSettings() =>
      LocationPlatform
.instance.openAppSettings();

  /// Opens the location settings page.
  ///
  /// Returns [true] if the location settings page could be opened, otherwise
  /// [false] is returned.
  static Future<bool> lmSettings() =>
      LocationPlatform
